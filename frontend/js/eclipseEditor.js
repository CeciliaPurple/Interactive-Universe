// eclipseEditor.js - Implementação específica para a página eclipse.html
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Configurações específicas para a página eclipse
    setupEclipseEditorHandlers();
});

// Configura manipuladores específicos para a página eclipse
function setupEclipseEditorHandlers() {
    // Adiciona manipuladores de salvamento específicos para a página eclipse
    if (window.adminDetector && window.adminDetector.isAdmin) {
        // Sobrescreve o método de salvamento para a página eclipse
        ...
        window.adminDetector.saveChanges = async function() {
            ...
            try {
                ...
                console.log('Alterações a serem salvas na página eclipse:', changes);
                ...
                console.error('Erro ao salvar alterações na página eclipse:', error);
